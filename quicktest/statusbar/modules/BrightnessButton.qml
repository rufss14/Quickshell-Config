...
Rectangle {
    ...
    Rectangle {
        ...
        color: ma.containsMouse
            ? (root.brightnessOpen ? T.Theme.pw(T.Theme.pal?.colors?.color9, 0.30) : T.Theme.hoverAccent)
            : (root.brightnessOpen ? T.Theme.pw(T.Theme.pal?.colors?.color9, 0.18) : "transparent")
